...
Agent OS support happens through GitHub Discussions and Issues.
...
- concrete documentation bugs
- broken links
- unclear instructions
- proposed repo changes with a specific acceptance condition
...
- **Polls** — explicit community preference checks

## Public/private safety

Do not post secrets, credentials, private host paths, personal data, customer data, or live operational details.

When sharing examples, replace real names, accounts, paths, and tokens with placeholders.
